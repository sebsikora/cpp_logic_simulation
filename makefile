...
sr_latch_demo: demos_src/sr_latch_demo.cpp $(CORE_SRC) $(DEVICES_SRC) $(UTILS_SRC) $(TP_SRC)
	$(CC) $(LIBS) $(CFLAGS) $(CORE_INC) $(UTIL_INC) $(TP_INC) $(CORE_SRC) $(UTILS_SRC) $(TP_SRC) demos_src/$@.cpp -o $@

sr_latch_demo_2: demos_src/sr_latch_demo_2.cpp $(CORE_SRC) $(DEVICES_SRC) $(UTILS_SRC) $(TP_SRC)
	$(CC) $(LIBS) $(CFLAGS) $(CORE_INC) $(DEVICE_INC) $(UTIL_INC) $(TP_INC) $(CORE_SRC) $(DEVICES_SRC) $(UTILS_SRC) $(TP_SRC) demos_src/$@.cpp -o $@
...
simple_rom_demo: demos_src/simple_rom_demo.cpp $(CORE_SRC) $(DEVICES_SRC) $(MD_SRC) $(UTILS_SRC) $(TP_SRC)
	$(CC) $(LIBS) $(CFLAGS) $(CORE_INC) $(DEVICE_INC) $(MD_INC) $(UTIL_INC) $(TP_INC) $(CORE_SRC) $(DEVICES_SRC) $(MD_SRC) $(UTILS_SRC) $(TP_SRC) demos_src/$@.cpp -o $@

simple_ram_demo: demos_src/simple_ram_demo.cpp $(CORE_SRC) $(DEVICES_SRC) $(MD_SRC) $(UTILS_SRC) $(TP_SRC)
	$(CC) $(LIBS) $(CFLAGS) $(CORE_INC) $(DEVICE_INC) $(MD_INC) $(UTIL_INC) $(TP_INC) $(CORE_SRC) $(DEVICES_SRC) $(MD_SRC) $(UTILS_SRC) $(TP_SRC) demos_src/$@.cpp -o $@

simple_terminal_demo: demos_src/simple_terminal_demo.cpp $(CORE_SRC) $(DEVICES_SRC) $(MD_SRC) $(UTILS_SRC) $(TP_SRC)
	$(CC) $(LIBS) $(CFLAGS) $(CORE_INC) $(DEVICE_INC) $(MD_INC) $(UTIL_INC) $(TP_INC) $(CORE_SRC) $(DEVICES_SRC) $(MD_SRC) $(UTILS_SRC) $(TP_SRC) demos_src/$@.cpp -o $@

game_of_life_cell_demo: demos_src/game_of_life_cell_demo.cpp $(CORE_SRC) $(DEVICES_SRC) $(UTILS_SRC) $(TP_SRC) $(GOL_SRC)
	$(CC) $(LIBS) $(CFLAGS) $(CORE_INC) $(DEVICE_INC) $(UTIL_INC) $(TP_INC) $(GOL_INC) $(CORE_SRC) $(DEVICES_SRC) $(UTILS_SRC) $(TP_SRC) $(GOL_SRC) demos_src/$@.cpp -o $@

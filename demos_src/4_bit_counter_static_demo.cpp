...
int main () {
	...
	Simulation sim{"test_sim", {false, 1}};

	// Instantiate the 4-bit counter device.
	Four_Bit_Counter_static fbcs{&sim, "test_counter", monitor_on, {{"run", true}}};

	// Add the 4-bit counter device.
	sim.AddComponent(&fbcs);
